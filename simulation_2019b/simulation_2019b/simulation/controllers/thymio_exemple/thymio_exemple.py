...
led =  robot.getLED('leds.bottom.right')
led2 = robot.getLED('leds.bottom.left')
led3 = robot.getLED('leds.prox.v.led0')
led4 = robot.getLED('leds.prox.v.led1')
led5 = robot.getLED('leds.top')
